...
In 2022, I chose the [Scala programming language](https://www.scala-lang.org/) as learning theme. This meant that I would use Scala as much as I could for projects big and small, with a focus on understanding how I could incorporate Scala into my toolset. I shared my motivations in greater detail in an earlier blogpost [2022: My Year in Scala](https://www.ddanieltan.com/posts/2022scala/).

As we end 2022, here's my recap and reflections on how I got to understand this programming language better and what I would recommend if you too are interested to do the same.
...
Using Scala for 2022's challenge was also incredibly fun! The challenge really nailed home the learning that Scala is a well-suited language for the general problem solving. In particular, I really enjoyed Scala's flexibility as it relates to using mutable/immutable data structures. While the immutability is encouraged as a default, no one bats an eyelid if you choose to use mutability on occasion, because frankly some problems in AoC are much easier to grok that way. 
...
- Use [Vscode](https://code.visualstudio.com/) with the [Metals extension](https://scalameta.org/metals/) as your development tool
...
![Bonsai Tree/Scala logo. [Credits](https://lexica.art/prompt/e42e0aba-a2cb-42fe-b952-2abdf8431ef0)](scala-bonsai.png)
