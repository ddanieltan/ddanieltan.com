...
Additionally, there are some situations where you do not want config files sync-ed. For example, I do not use this system to sync my shell configs because my shell configs might contain sensitive environment variables or have settings unique to the type of hardware the software is running on.
