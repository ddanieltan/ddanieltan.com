...
# Quarto
One reason why I got tempted to start a blog again is [Quarto](https://quarto.org/)! Quarto is the shiny, new publishing framework (from ~~RStudio~~[Posit](https://posit.co/)) that I use to publish this blog. Quarto is reminiscent of Rmarkdown, but rebuilt around the pandoc engine and promises to be programming language agnostic. My first couple of hours playing with Quarto was a real treat, and I appreciated the vision of having a single framework where a Data Scientist could use any language to publish content in any format.
...
The official docs are extensive and well-written. Specific to building a blog, I frequently find myself on the [website page](https://quarto.org/docs/websites/), [publishing page](https://quarto.org/docs/publishing/) and thumbing through their [gallery](https://quarto.org/docs/gallery/) for inspiration. 
